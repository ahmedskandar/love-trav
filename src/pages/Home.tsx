...
const Home = () => {
  return (
    <div className="relative flex h-[100svh] flex-col bg-[url(https://images.unsplash.com/photo-1589519160732-57fc498494f8?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-cover bg-top">
      ...
      <main className="z-10 mx-auto flex h-full max-w-xl flex-col justify-center p-5 py-10 text-center text-white lg:max-w-2xl xl:mx-0 xl:mt-10 xl:w-1/2 xl:max-w-none xl:p-14 xl:text-left">
